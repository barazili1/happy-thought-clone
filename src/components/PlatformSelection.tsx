  ...
  return (
    <div dir="rtl" className="relative flex flex-col min-h-full font-sans overflow-x-hidden max-w-full">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-24 right-0 w-72 h-72 rounded-full bg-[rgba(125,249,255,0.15)] blur-3xl" />
        <div className="absolute top-40 left-0 w-64 h-64 rounded-full bg-[#7DF9FF]/10 blur-3xl" />
      </div>
      ...
      <header className="relative z-10 px-6 pt-8 pb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-black border border-[rgba(125,249,255,0.30)] shadow-[0_6px_18px_rgba(13,148,136,0.12)]">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#7DF9FF] text-black shadow-[0_6px_18px_rgba(13,148,136,0.35)]">
      ...
      <main className="relative z-10 px-6">
            ...
            return (
              <motion.button
                ...
                className={`relative w-full text-right rounded-3xl p-4 border-2 transition-all duration-300 ${
                  active
                    ? 'bg-black border-[#7DF9FF] shadow-[0_16px_36px_rgba(13,148,136,0.22)]'
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`relative w-[70px] h-[70px] shrink-0 rounded-2xl overflow-hidden border-2 ${
                      active ? 'border-[#7DF9FF]' : 'border-zinc-200'
                    }`}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] font-mono font-bold px-1.5 py-0.5 rounded-md bg-[rgba(125,249,255,0.10)] text-[#7DF9FF] border border-[rgba(125,249,255,0.30)]">
                        {p.latency}
                      </span>
                    </div>
                    ...
                    <div className="mt-2.5 flex items-center gap-2">
                      <span className="inline-flex items-center gap-1 text-[10px] font-black text-[#7DF9FF] bg-[rgba(125,249,255,0.10)] border border-[rgba(125,249,255,0.30)] rounded-lg px-2 py-1">
                      ...
                      <span className="inline-flex items-center gap-1 text-[10px] font-black text-white/70 bg-white/10 border border-zinc-200 rounded-lg px-2 py-1">
                        <Zap className="w-3 h-3 text-[#7DF9FF]" /> {p.geo}
                      </span>
                    </div>
                  </div>
                  ...
                  <div
                    className={`w-6 h-6 shrink-0 rounded-full border-2 flex items-center justify-center ${
                      active ? 'bg-[#7DF9FF] border-[#7DF9FF]' : 'bg-black border-white/10'
                    }`}
                  >
        ...
        <div className="mt-6 rounded-3xl bg-black border border-zinc-200 p-4 shadow-[0_10px_28px_rgba(15,23,42,0.07)]">
          <div className="flex items-center justify-between pb-3 border-b border-zinc-100">
            ...
            <div className="text-left">
              ...
              <div className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#7DF9FF] animate-pulse" />
          ...
          <button
            ...
            disabled={isConnecting}
            className="mt-4 w-full h-14 rounded-2xl bg-[#7DF9FF] text-black font-black text-base flex items-center justify-center gap-3 shadow-[0_12px_28px_rgba(13,148,136,0.35)] active:scale-[0.98] transition-all disabled:opacity-60"
          >
          ...
          <div className="mt-3 flex items-center justify-center gap-6">
            <div className="flex items-center gap-1.5 text-white/50">
              <Shield className="w-3.5 h-3.5 text-[#7DF9FF]" />
              <span className="text-[10px] font-bold">اتصال آمن</span>
            </div>
            <div className="flex items-center gap-1.5 text-white/50">
              <Lock className="w-3.5 h-3.5 text-[#7DF9FF]" />
